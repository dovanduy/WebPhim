...
(function (e) {
    e.fn.easyTooltip = function (t) {
        ...
        e(this).hover(function (n) {
            r = t.content != "" ? t.content : i;
            r = t.useElement != "" ? e(t.useElement).html() : r;
            e(this).attr("title", "");
            if (r != "" && r != undefined) {
                e("body").append("<div id='" + t.tooltipId + "'>" + r + "</div>");
                e("#" + t.tooltipId).css("position", "absolute").css("top", n.pageY - t.yOffset + "px").css("left", n.pageX + t.xOffset + "px").hide().fadeIn("fast")
            }
        }, function () {
            e("#" + t.tooltipId).remove();
            e(this).attr("title", i)
        });
